...
namespace My_Snake_Game_2024
{
    ...
    {
      ///(done) /// 4- protection againest food not appear in snake body.(done)
      ///(done) /// 5- globals vari not use them as parameter .....(done)
      ///(done) /// 6- make employee for list of snake parts....(done)
      ...
      ///(done) /// 11- solve the bug of ("if the snakehead beside the food and collission occured snake not eat the foof why?!!!"); 
       /// 12- slove the bug if you press fast it can move left during moving right and it can move up during running down
      ///(done) /// 13- solve the bug in some scenarios if the snake length become too big the game stopped suddenly.
